        ...
        <View style={styles.testCard}>
          ...
          <View style={styles.toneArea}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (!currentTestIsCatchTrial) {
                  playTone(frequency, currentEar, TONE_PULSE_DURATION_MS * TONE_PULSE_COUNT + TONE_PULSE_GAP_MS * (TONE_PULSE_COUNT - 1))
                } else {
